      ...
      <div className="rounded-2xl border border-emerald-900/40 bg-[#0d1612] p-8 shadow-sm text-center">
        {!preview ? (
          <div className="border-2 border-dashed border-emerald-900/50 rounded-xl p-12 hover:border-emerald-500/50 transition-colors">
            ...
            <p className="text-gray-300 font-medium mb-2">Drag and drop your field image here</p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <label className="cursor-pointer rounded-lg border border-emerald-600 px-6 py-2.5 text-sm font-semibold text-emerald-400 hover:bg-emerald-600 hover:text-white transition-colors text-center">
                Change Image
                <input type="file" className="hidden" accept="image/*" onChange={handleFileChange} />
              </label>
              <button
